...
export default function ReturnsPage() {
  return (
    <div className="min-h-screen px-5 py-6 pb-24 max-w-2xl mx-auto">
      ...
      <p className="text-xs text-ink-faint mb-6">Conformă cu OUG 34/2014. Ultima actualizare: {COMPANY.legalUpdated}</p>
      ...
      <div className="space-y-5 text-sm text-ink-soft leading-relaxed [&_h2]:font-display [&_h2]:text-lg [&_h2]:text-ink [&_h2]:mt-6 [&_h2]:mb-1">
        ...
        <p>
          ...
          declarație clară la {COMPANY.email} înainte de expirarea termenului.
        </p>
        ...
        <p>
          Pentru retururi și reclamații: {COMPANY.email}. Te poți adresa și ANPC (anpc.ro) sau platformei SOL a UE
        ...
        <p className="flex items-start gap-1.5 text-xs text-ink-faint pt-6 border-t border-line mt-6">
          ...
          <span>
            Acest document este în curs de revizuire juridică înainte de lansare. Vezi și{' '}
